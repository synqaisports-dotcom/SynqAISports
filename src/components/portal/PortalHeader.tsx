...
import { PortalClubBadge } from '@/components/portal/PortalClubBadge';
...
export function PortalHeader({
  ...
  return (
    <header className="sticky top-0 z-20 flex h-14 shrink-0 items-center justify-between gap-3 border-b border-primary/15 bg-[hsl(205_42%_7%/_0.72)] px-4 backdrop-blur-md supports-[backdrop-filter]:bg-[hsl(205_42%_7%/_0.55)]">
      <div className="flex min-w-0 flex-1 items-center gap-2">
        <PortalSidebarMobileTrigger />
        <PortalClubBadge clubName={clubName} clubLogoUrl={clubLogoUrl} />
      </div>
