...
import { createSponsor, updateSponsor, uploadSignageMedia, type SignageActionState } from '@/app/actions/signage';
...
export function SponsorsPanel({ sponsors }: Props) {
  ...
  const lastOk = createState.ok || updateState.ok;

  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-3">
        <p className="text-sm text-muted-foreground">Patrocinadores que rotan en las pantallas del club.</p>
      ...
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
        {sponsors.map((sponsor) => (
          <button
            ...
            className="portal-section-surface rounded-xl p-4 text-left transition hover:border-cyan-400/30"
          >
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-1 flex flex-wrap gap-1">
                  ...
                  {!sponsor.active ? <Badge variant="destructive">Inactivo</Badge> : null}
                </div>
              </div>
            </div>
          </button>
        ...
        <PortalSheetContent maxWidth="md">
          ...
          <PortalSheetBody>
            ...
            >
              ...
              <input type="hidden" name="active" value={editing?.active !== false ? 'true' : 'false'} />
