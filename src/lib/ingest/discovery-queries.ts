/**
 * Búsquedas por CATEGORÍA — no productos nombrados.
 * Las predicciones salen de titulares reales donde origen > España.
 */
export type DiscoveryQuery = {
  id: string;
  /** Consulta abierta — no marca ni producto concreto */
  news_query: string;
  reddit_query: string;
