...
export const FORMATIONS_DATA: Record<string, Record<FormationKey, Position[]>> = {
  f11: {
    ...
    "4-2-3-1": [
      ...
      {x: 0.65, y: 0.5}, {x: 0.65, y: 0.2}, {x: 0.65, y: 0.8},
      {x: 0.85, y: 0.5}
    ],
    "5-4-1": [
      {x: 0.05, y: 0.5},
  ...
  f7: {
    "3-2-1": [
      ...
      {x: 0.55, y: 0.35}, {x: 0.55, y: 0.65}, // MID
      {x: 0.85, y: 0.5} // ATK
    ],
    "2-3-1": [
      {x: 0.05, y: 0.5},
      {x: 0.25, y: 0.3}, {x: 0.25, y: 0.7},
      {x: 0.55, y: 0.15}, {x: 0.55, y: 0.5}, {x: 0.55, y: 0.85},
      {x: 0.85, y: 0.5}
    ],
    "3-1-2": [
      {x: 0.05, y: 0.5},
    ...
    "1-4-1": [
      {x: 0.05, y: 0.5},
      {x: 0.25, y: 0.5},
      {x: 0.55, y: 0.1}, {x: 0.55, y: 0.35}, {x: 0.55, y: 0.65}, {x: 0.55, y: 0.9},
      {x: 0.85, y: 0.5}
    ]
  },
  futsal: {
