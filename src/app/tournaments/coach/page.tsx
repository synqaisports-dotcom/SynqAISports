...
export default function TournamentCoachPlaceholderPage() {
  return (
    <Suspense
      fallback={
...
function Inner() {
  ...
  const title = useMemo(() => {
    if (teamId) return "Micro‑app Entrenadores (Equipo)";
    return "Micro‑app Entrenadores";
  }, [teamId]);
      ...
      <main className="relative z-10 mx-auto w-full max-w-3xl px-4 py-10">
        <div className="rounded-2xl border border-[#00F2FF]/20 bg-[#0F172A]/60 backdrop-blur-2xl p-6 shadow-[0_20px_60px_rgba(0,0,0,0.45)]">
          ...
          <p className="mt-3 text-sm text-white/70">
            Placeholder. La micro‑app de entrenadores para histórico de equipos se implementará más adelante como terminal/microapp.
          </p>
          ...
          <div className="mt-6 rounded-xl border border-white/5 bg-black/25 p-4">
            ...
            <div className="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
              ...
              <div className="sm:col-span-2">
                <p className="text-[10px] uppercase tracking-widest text-[#00F2FF]/60 font-bold">Equipo</p>
                <p className="mt-1 font-mono text-[12px] text-white/85 break-all">{teamId || "—"}</p>
              </div>
            </div>
          </div>
