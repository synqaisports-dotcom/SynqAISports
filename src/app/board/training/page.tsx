  ...
  return (
    <div className={cn("h-full flex flex-col bg-[#04070c] overflow-hidden relative", isLegacyDevice && "perf-lite")}>
      ...
      <header className="fixed top-6 left-1/2 -translate-x-1/2 z-[100] flex flex-col items-center gap-4 w-full max-w-4xl px-4 pointer-events-none">
        <div className="flex items-center gap-2 md:gap-4 px-4 py-2 md:px-6 md:py-3 bg-black/60 backdrop-blur-2xl border border-amber-500/30 rounded-[2rem] shadow-2xl animate-in slide-in-from-top-4 duration-700 scale-[0.8] md:scale-90 lg:scale-100 origin-top pointer-events-auto">
