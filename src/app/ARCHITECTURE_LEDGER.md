...
- **Radius Fix**: El motor de dibujo ahora utiliza `min(width, height)` para asegurar que el trazo sea un círculo perfecto incluso si el usuario intenta forzar un redimensionamiento asimétrico.
