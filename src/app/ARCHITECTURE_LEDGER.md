...
- **v9.21.0**: **PROTOCOL_TAP_TO_SUB**:
    - Implementación de sustitución en 2 pasos (OUT/IN) en Smartwatch.
    - Eliminación de gestos de arrastre (drag) para evitar errores táctiles.
- **v9.22.0**: **PROTOCOL_UNIFIED_SUB_POCKET**:
