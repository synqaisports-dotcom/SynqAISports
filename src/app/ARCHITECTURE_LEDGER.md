...
## 5. Protocolo de Pizarra y Dibujo (v9.8.5)
...
- **Fix ReferenceError (Cross-Terminal)**: Reparación del error de ejecución al redimensionar objetos (`maxY is not defined`). Sincronización total de los punteros de redimensionamiento con el objeto `bounds` en Entrenamiento y Promo.
