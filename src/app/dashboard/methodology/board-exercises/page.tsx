    ...
    <div className="space-y-8 animate-in fade-in duration-1000 p-8 lg:p-12">
      <div className="flex flex-col gap-2 border-b border-white/5 pb-6">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] font-black text-primary/80 tracking-[0.5em] uppercase">Launcher_Exercise_Designer</span>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center pt-12">
        <div className="aspect-video bg-black border border-primary/20 rounded-[3rem] overflow-hidden relative group order-last lg:order-first">
           <div className="absolute inset-0 bg-grid-pattern opacity-10" />
           <div className="absolute inset-0 flex items-center justify-center">
              <LayoutGrid className="h-32 w-32 text-primary/10 group-hover:scale-110 transition-transform duration-1000" />
           </div>
           <div className="absolute bottom-8 left-8 right-8 p-6 bg-black/60 backdrop-blur-xl border border-white/5 rounded-2xl">
              <p className="text-[9px] font-black text-primary uppercase tracking-widest mb-1">Módulo Neural IA</p>
