    ...
    <div className="space-y-8 animate-in fade-in duration-1000 p-8 lg:p-12">
      <div className="flex flex-col gap-2 border-b border-white/5 pb-6">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] font-black text-amber-500 tracking-[0.5em] uppercase">Launcher_Match_Elite</span>
        </div>
        ...
        <div className="space-y-8">
           ...
           <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-3 px-6 py-4 bg-white/5 border border-white/5 rounded-2xl">
                 <Monitor className="h-4 w-4 text-amber-500/40" />
                 <span className="text-[10px] font-black text-white/20 uppercase tracking-widest">Recomendado: Pantalla Completa (F11)</span>
              </div>
           </div>
        </div>

        <div className="aspect-video bg-black border border-amber-500/20 rounded-[3rem] overflow-hidden relative group">
           <div className="absolute inset-0 bg-grid-pattern opacity-10" />
           <div className="absolute inset-0 flex items-center justify-center">
              <Trophy className="h-32 w-32 text-amber-500/5 group-hover:scale-110 transition-transform duration-1000" />
           </div>
           <div className="absolute bottom-8 left-8 right-8 p-6 bg-black/60 backdrop-blur-xl border border-white/5 rounded-2xl">
              <p className="text-[9px] font-black text-amber-500 uppercase tracking-widest mb-1">Estado de Sincronización</p>
