...
2. Copia:
   ...
   **Alternativa si falla:** en la misma página, pestaña **Legacy API Keys** → copia la clave **anon** (empieza por `eyJ`, muy larga).

   > Copia con el botón **Copy**, nunca escribas "anon" a mano.
...
- [Fase 2b — desglose corredores](https://github.com/synqaisports-dotcom/SynqAISports/blob/main/supabase/migrations/20260626120000_trendpulse_phase2b_breakdown.sql) (CN/US/ES/POD en tarjetas)
