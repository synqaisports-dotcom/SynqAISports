...
# SynqSports Pro - ARCHITECTURE_LEDGER v9.8.1 (Edición Integrada)

Este documento es el registro maestro inmutable de la arquitectura técnica, protocolos de seguridad y flujos de trabajo de SynqSports Pro.

## 5. Protocolo de Pizarra y Dibujo (v9.8.1)
...
- **Corrección de Aspect Ratio**: Implementación de forzado 1:1 en píxeles para jugadores, círculos, balones y setas. Elimina la distorsión de óvalos en campos rectangulares compensando el ratio del canvas en las coordenadas normalizadas.
